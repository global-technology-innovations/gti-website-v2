...
export const services: Service[] = [
	...
	},
	{
		...
		fullDescription: "Професійно монтуємо гіпсокартонні конструкції: перегородки, багаторівневі стелі та декоративні елементи.",
		image: "/hero-bg.png",
		icon: Layers,
	...
	},
	{
		...
		fullDescription: "Влаштовуємо надійне бруківкове покриття для доріжок, дворів та парковок з урахуванням навантажень та дизайну.",
		image: "/hero-bg.png",
		icon: Layers,
	...
	},
	{
		...
		fullDescription: "Монтуємо паркетні підлоги, проводимо циклевання та відновлення старих покриттів з натурального дерева.",
		image: "/hero-bg.png",
		icon: Home,
	...
	},
	{
		...
		fullDescription: "Виконуємо укладання керамічної, керамогранітної та мозаїчної плитки на підлоги та стіни будь-яких приміщень.",
		image: "/hero-bg.png",
		icon: BrickWall,
	...
	},
	{
		...
		fullDescription: "Професійно зводимо цегляні та блочні стіни, перегородки і огорожі з дотриманням технологічних норм.",
		image: "/hero-bg.png",
		icon: Hammer,
	...
	},
	{
		...
		fullDescription: "Виконуємо монтаж нових та ремонт існуючих дахів, забезпечуючи надійний захист будівлі від негоди.",
		image: "/hero-bg.png",
		icon: House,
	...
	},
	{
		...
		fullDescription: "Наклеюємо паперові, флізелінові та текстильні шпалери з підгонкою малюнка та якісною підготовкою поверхні.",
		image: "/hero-bg.png",
		icon: Wallpaper,
	...
	},
	{
		...
		fullDescription: "Здійснюємо внутрішні ремонтні роботи під ключ: від чорнових до фінішних етапів з урахуванням побажань клієнта.",
		image: "/hero-bg.png",
		icon: Home,
	...
	},
	{
		...
		fullDescription: "Будуємо та ремонтуємо дороги, тротуари й майданчики з урахуванням вимог до навантаження та довговічності.",
		image: "/hero-bg.png",
		icon: House,
