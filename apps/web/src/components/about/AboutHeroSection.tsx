...
export function AboutHeroSection() {
	...
	return (
		<section className="relative mx-4 bg-background rounded-b-3xl overflow-hidden min-h-[400px]">
			<div className="absolute top-0 left-0 w-[45%] max-w-[480px] h-full z-0 pointer-events-none">
				{/* eslint-disable-next-line @next/next/no-img-element */}
				<img src="/about-bg-left.svg" alt="" className="w-full h-full object-contain object-left-top select-none" aria-hidden />
			</div>
			<div className="absolute top-0 right-0 w-[45%] max-w-[480px] h-full z-0 pointer-events-none">
				{/* eslint-disable-next-line @next/next/no-img-element */}
				<img src="/about-bg-right.svg" alt="" className="w-full h-full object-contain object-right-top select-none" aria-hidden />
			</div>
