...
export function CallToActionSection({
	...
	return (
		<section id={sectionId} className="relative mx-4 overflow-hidden rounded-3xl bg-secondary py-10 lg:py-16 px-4">
			<div
				aria-hidden="true"
				className="absolute top-0 left-0 w-[45%] max-w-[480px] h-full z-0 pointer-events-none animate-slide-up bg-[url('/call-to-action-right-bg.svg')] bg-contain bg-left-top bg-no-repeat"
			/>
			<div
				aria-hidden="true"
				className="absolute top-1/3 right-0 w-[45%] max-w-[480px] h-full z-0 pointer-events-none animate-slide-right bg-[url('/call-to-action-left-bg.svg')] bg-contain bg-right-bottom bg-no-repeat"
			/>
