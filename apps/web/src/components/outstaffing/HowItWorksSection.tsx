						...
						return (
							<div key={step.key} className="relative">
								...
								<Card className="p-6 text-center relative z-10 bg-white hover:shadow-lg transition-shadow duration-300 border border-blue-500">
									...
									<h3 className="text-lg font-semibold text-gray-800 mb-3">{t(`steps.${step.key}.title`)}</h3>
									<p className="text-gray-600 text-sm leading-relaxed">{t(`steps.${step.key}.description`)}</p>
								</Card>
							</div>
						);
					})}
