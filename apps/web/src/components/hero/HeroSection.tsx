				...
				<div className="container py-22 flex justify-between items-center relative mx-auto">
					<div className="flex flex-col items-start">
						<div className="max-w-[630px]">
							...
							<p className="text-primary mt-6 text-left">
								{t("description")}
							</p>
						</div>
					...
					<div className="relative bg-secondary w-fit h-fit max-w-[410px] rounded-lg p-6 self-end">
						...
						<p className="text-white mt-4">
							Компанія продемонструвала високий рівень
							професіоналізму та надійності. Проєкт було виконано
							вчасно, з відмінною якістю та чіткою комунікацією на
							всіх етапах.
						</p>
					</div>
				</div>
